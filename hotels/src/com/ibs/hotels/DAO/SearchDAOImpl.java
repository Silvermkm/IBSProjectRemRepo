...
public class SearchDAOImpl implements SearchDAO {
	...
	public List<Hotel> listHotels(String location, Date checkIn, Date checkOut,
		...
		// HotelListRespons result = restTemplate.getForObject(url,
		// HotelListRespons.class);
		// LinkedHashMap<String,HotelListResponse> javaResp
		// =(LinkedHashMap<String,HotelListResponse>)response;
		// //HotelListResponse value = null;
		// for (Map.Entry<String, HotelListResponse> entry :
		// javaResp.entrySet()) {
